...
name: "Dex3-1 灵巧手开发"
path: "dexterous_hand"
url: "https://doc-cdn.unitree.com/11/251/zh/11_251_zh"
index_path: "03_03"
parents:
  - "底层运动开发"
parent_paths:
...
本文只介绍如何如何通过 unitree_sdk2 控制 G1  上的灵巧手，文档最后附 Demo 程序，其中有示例获取灵巧手的状态信息、控制功能等。
灵巧手区分为左右手。其中，单只 Dex3-1 灵巧手左右对称。在进行灵巧手控制的时候，分别对不同的消息通道进行通信并控制对应的灵巧手。详见灵巧手控制控制方式一节。

![](../assets/ebcaceac448c424c98842959141da5b1_1540x998_eea89d2d95a0.jpg)


可从 [此处](https://support.unitree.com/home/zh/G1_developer/get_sdk) 访问 unitree_sdk2，运行方式详见 [《快速开发》](https://support.unitree.com/home/zh/G1_developer/quick_development)。
...
**左手**
![](../assets/b39e500d28bc4f98850b089d53ff53f7_3840x2160_7578e9c3e1ed.jpg)
...
**右手**
![](../assets/5f70e4b9396444289d945ced51e67a52_3840x2160_50c70815736f.jpg)
...
```
其中  HandState_、IMUState_在H 1 SDK 开发指南中的 [《H-2 底层服务接口章节》]([宇树科技 文档中心](https://support.unitree.com/home/zh/H1_developer/H1-2_Basic_Services_Interface)) 来了解 MotorState_等结构体中的数据填充规则。PressSensorState_ 结构体会在下面解释说明。
power_v 表示灵巧手接入电源总电压。
power_a 表示灵巧手接入电源总电流。system_v 表示灵巧手内部接入电源电压。
device_v 表示灵巧手中降压模块输出电压。
...
```
其中 pressure 为单个传感器：
![](../assets/82cc7af5d0e64162bb0a5c078f87a256_7680x4320_054d358c03f8.jpg)
![](../assets/64b093c7752344e7a8567524fc0c69cd_7680x4320_98fdd00629a7.jpg)
图中 ID 表示一个传感器数据包PressSensorState_。数据包中pressure[12]数据索引对应的传感器位置已经在图中标识出。
