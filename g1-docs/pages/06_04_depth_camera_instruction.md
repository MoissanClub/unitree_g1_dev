---
name: "深度相机例程"
path: "depth_camera_instruction"
url: "https://doc-cdn.unitree.com/11/267/zh/11_267_zh"
index_path: "06_04"
parents:
  - "更多例程"
parent_paths:
...
![](../assets/ddc4f187060d434587e2f08ea0045e3c_1042x718_1f19a9f4976c.png)

- 产品主页：[https://www.intelrealsense.com/depth-camera-d435/realsense](https://www.intelrealsense.com/depth-camera-d435/realsense)
- 详细文档：[https://dev.intelrealsense.com/docs/docs-get-started](https://dev.intelrealsense.com/docs/docs-get-started)
- 官方 github 地址：[https://github.com/IntelRealSense](https://github.com/IntelRealSense)

深度相机坐标系、深度相机坐标系与机器人中心坐标系关系：
![](../assets/4afc81d7c48c452aaa4fc078f90a859f_627x206_c6b40f1cf8c8.png)
![](../assets/31b7d70c4ec1463a8143af70c43f33b9_592x897_8b3968dbee72.png)
...
- windows 端，直接下载` Intel.RealSense.Viewer.exe`
 - 软件，链接：[https://github.com/IntelRealSense/librealsense/releases](https://github.com/IntelRealSense/librealsense/releases)

linux 端，需要编译安装 SDK。
- Ubuntu 18/20/22 LTS 安装参考：[https://github.com/IntelRealSense/librealsense/blob/master/doc/installation.md](../assets/installation_32cff74a6a21.md)
- NVIDIA Jetson 系统安装参考：[https://github.com/IntelRealSense/librealsense/blob/master/doc/installation_jetson.md](../assets/installation_jetson_1b23f7963594.md)
- Raspberry Pi 系统安装参考：[https://github.com/IntelRealSense/librealsense/blob/master/doc/RaspberryPi3.md](../assets/RaspberryPi3_3fc912a6a656.md)


使用前，需要您在机器人的NX计算机平台上，安装 librealsense。
硬件连接正常的情况下，终端输入 `realsense-viewer` 打开软件，可以查看到：
![](../assets/b75a0c1f522141d5babdce835dfd77ed_1340x791_8a5d14fc4c53.png)


## 2.2 通过 ros 获取数据
相机 ros 驱动代码仓库：[https://github.com/IntelRealSense/realsense-ros](https://github.com/IntelRealSense/realsense-ros)
详细使用说明参考代码仓库的 readme 文件。
平时使用，建议直接通过 sdk 获取数据并处理。


## 2.3 通过 SDK 获取数据
相机 SDK 代码仓库：[https://github.com/IntelRealSense/librealsense](https://github.com/IntelRealSense/librealsense)
...
![](../assets/32f15957b6264156b213539dc45adb4e_641x996_cc99cb4a944c.jpg)
...
![](../assets/31fc889ee41748158cbd68bbaaba86f7_615x1016_0d97233efcb0.jpg)
