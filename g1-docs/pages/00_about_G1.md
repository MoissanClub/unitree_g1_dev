...
name: "关于G1"
path: "about_G1"
url: "https://doc-cdn.unitree.com/11/223/zh/11_223_zh"
index_path: "00"
parents: []
parent_paths: []
---
...
|类型<div style="width: 100pt"> </div>| G1 | G1-EDU | 
|---- | ---   | --- | 
|总自由度 | 23 |  23~43 |
|  单腿自由度  |   6  |  6  |
...
| 部件说明|![](../assets/b05b4ee41a344359bd043bfcd101bb3d_4136x2719_5011825c7e08.png)|![](../assets/4d98624a650e49d8948672dcb92a13f4_4135x2718_c42204e62ad3.png)|
...
| 灵巧手 Dex3-1 电气参数 |  |
| :-: | - |
| 渲染图 | ![](../assets/20e350f308544a96a54432b533c0b665_270x175_934ff66c16e4.png)
|
| 工作电压 | 12-58V  |
| 感知范围 |10g-2500g|
| 自由度 |总自由度：7<br>&emsp;&emsp;1.大拇指 3 个主动自由度;<br>&emsp;&emsp;2.食指 2 个主动自由度;<br> &emsp;&emsp;3.中指 2 个主动自由度。|
| 关节角度 |大拇指：0°~+100°, -35°~+60°, -60°~+60°；<br>食指、中指：0°~+90°，0°~+100°|
| 阵列传感器数量 |9 |
...
![5](../assets/cd3d0a7d4f384eedb21fb7556fc09d25_1670x2365_98503e6ff3ae.png "正面")

![5](../assets/26eebb64bc4d4a7d88bd09c752f98490_1670x2365_1c2cb2480338.png "背面")
...
<center>
 ...
 ![2](../assets/ef105e92a6f7487eaf31f9169c44dfd8_3707x2675_e44e5edf8caa.jpg "G1 顶部视图")
...
| 10 | I/O   | I/O OUT | 12V: 12V/3A电源输出 <br>GPIO详见下表|

<center>

![1](../assets/dd0ef71208124633bb9763a5efa02f94_2672x1892_32bc60d5619b.jpg "RJ45及IO列表")
...
[https://docs.nvidia.com/jetson/archives/r35.2.1/DeveloperGuide/text/HR/JetsonModuleAdaptationAndBringUp/JetsonOrinNxSeries.html#identifying-the-gpio-number](../assets/JetsonOrinNxSeries_c067952c0fbd.html)
!!!
使用说明请参考：
...
![2](../assets/eb95be6689af40f4816e2351a74d0c2b_2094x1521_145c4826cacb.png "G1 背部视图")
...
> - 宇树并未在 NVIDIA Jetson Orin 模块上部署服务。
...
![5](../assets/cbb7fdb3bc3444ce95dfc7300df8786f_356x393_940de62449c0.png "MID360激光雷达FOV")

![5](../assets/ff0591fcc6bc476bab77ebca2f92f198_1715x2363_6f0f12887fa6.png "D435i深度相机FOV")
</center>

G1头部搭载D435i深度相机，为机器人提供了卓越的视觉感知能力，能够更准确地感知和理解周围环境，实现精确的空间感知和障碍物检测，使机器人能够更智能、灵活地与环境进行交互和应对各种场景。


![](../assets/b7aab82da80940faa773f213baf13e32_13364x6401_c341243ae5e1.jpg "MID360+D435i合并的FOV")
...
| 23 dof |  29dof|
|-------| ------|
|   ![](../assets/1dcad03430904e14aec140c9e7e1e981_1304x2033_0f581e80a7f4.png) | ![](../assets/24b7205f093d45918fcce5459931e3a8_1304x2033_5fa7c7461e6a.png) |

# 机器人规格

|  型号 <div style="width: 100pt"> </div> |  G1 |  G1-EDU |
| :--- | --- |-----|
...
|  关节电机  |  低惯量高速内转子永磁同步电机<br>（更好的响应速度和散热）| 低惯量高速内转子永磁同步电机<br>（更好的响应速度和散热） |
|  膝关节最大扭矩[1]  |   90N.m  | 120N.m |
|  手臂最大负载[2]  |  约2Kg  | 约3Kg  |
|  小腿+大腿长度  |   0.6M  | 0.6M  |
|  手臂臂展  |  约0.45M | 约0.45M  |
|  超大关节运动空间  |  腰关节：Z±155°<br>膝关节：0~165°<br>髋关节：P±154°、R-30~+170°、Y±158° | 腰关节：Z±155°、X±45°、Y±30°<br>膝关节：0~165°<br>髋关节：P±154°、R-30~+170°、Y±158°<br>腕关节：P±92.5°、Y±92.5° |
|全关节中空内走线|有|有|
|关节编码器|双编码器|双编码器|
|散热系统|局部风冷散热|局部风冷散热|
|供电方式|13串锂电池|13串锂电池|
...
<center><img src="../assets/9134c51202fa42c9b1ef9c27320f444d_170x299_e56f58e589b7.png"></center>

| 属性 | 参数 |
| -- | -- |
| 核心模块 | Jetson T5000 |
| 核心算力（FP4） | 2070TFLOPS |
| GPU | 2560 核 NVIDIA Blackwell 架构 GPU，<br>配备 96 个第五代 Tensor Core |
| CPU | 14 核 Arm® Neoverse®-V3AE 64 位 CPU |
| 统一内存 | 128GB 256位 LPDDR5X |
| 储存 | 1TB |
| 峰值功耗 | 130W |
| USB接口配置 | Type-A 3.2 * 2 <br> Type-C 3.1 *2 |
| 操作系统 | Jetson Linux 38.2.1 (基于Ubuntu) |
| Jetpack | Jetpack 7 |

!!! note Thor背包
此配件基于Jetson Thor，提供强劲的算力，支持部署对算力要求较高的大模型。
“统一内存”指的是GPU与CPU同时共享这部分内存。
如有需要，请联系销售团队咨询采购。
!!!
