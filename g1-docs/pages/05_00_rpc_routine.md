...
name: "RPC例程"
path: "rpc_routine"
url: "https://doc-cdn.unitree.com/11/246/zh/11_246_zh"
index_path: "05_00"
parents:
  - "高层运动开发"
parent_paths:
  - "high_motion_development"
---
# RPC例程

本例程通过高层运控的 RPC 接口，实现了机器人的模式切换，以及站立，运动等的控制。
!!! note
ai_sport >= 8.2.0.0版本为LOCO_SERVICE_NAME = "sport";
低于该版本 LOCO_SERVICE_NAME = "loco"。
...
<!--
| `--get_balance_mode`   | 获取机器人的平衡模式                     |      /      |
| `--get_swing_height`   | 获取机器人的抬腿高度                     |      /      |
| `--get_stand_height`   | 获取机器人的站立高度                     |      /      |
| `--set_balance_mode`   | 设置平衡模式                             |      1      |
| `--set_swing_height`   | 设置抬腿高度，单位(m)                    |    0.1    |
| `--set_stand_height`   | 设置站立高度，单位(m)                    |     0.55     |
-->
